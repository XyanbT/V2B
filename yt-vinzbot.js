...
const isRegistered = checkRegisteredUser(sender)
   const isRegister = register.includes(sender)
    ...
    const totalhit = JSON.parse(fs.readFileSync("./lib/totalcmd.json"))[0]
      ...
      const daftar1 = `Hai kak  ${pushname} ${ucapanWaktu} \n\nSebelum Menggunakan Bot VERIFY DULU KONTOL\nketik Verify  Ya kak `
...
//////
			...
			tc = `MAAF KA NOMER KAMU BLOM TERDAFTAR DI DATABASE SILAHKAN KETIK !verify UNTUK MENDAFTAR DI ZIZUBOT☕`
			ind = {
...
「All chat broadcast」`,
			...
			"buttonText": {"displayText": "BY ZIZUBOT"
